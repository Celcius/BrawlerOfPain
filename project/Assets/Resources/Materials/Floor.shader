...
/////// Normals:
                ...
                float3 normalLocal = tex2D(_normal,TRANSFORM_TEX(node_156.rg, _normal)).rgb;
...
/////// Diffuse:
                ...
                float4 node_2 = tex2D(_diffTex,TRANSFORM_TEX(node_156.rg, _diffTex));
                float3 node_69 = lerp(node_2.rgb,tex2D(_bloodTex,TRANSFORM_TEX(node_156.rg, _bloodTex)).rgb,_bloodBlend);
...
////// Specular:
                ...
                finalColor += diffuseLight * lerp(node_2.rgb,(_node_147.rgb*tex2D(_node_121,TRANSFORM_TEX(node_156.rg, _node_121)).rgb),_bloodBlend);
                finalColor += specular;
/// Final Color:
...
/////// Normals:
                ...
                float3 normalLocal = tex2D(_normal,TRANSFORM_TEX(node_157.rg, _normal)).rgb;
                float3 normalDirection =  normalize(mul( normalLocal, tangentTransform )); // Perturbed normals
...
/////// Diffuse:
                float NdotL = dot( normalDirection, lightDirection );
                float4 node_2 = tex2D(_diffTex,TRANSFORM_TEX(node_157.rg, _diffTex));
                float3 node_69 = lerp(node_2.rgb,tex2D(_bloodTex,TRANSFORM_TEX(node_157.rg, _bloodTex)).rgb,_bloodBlend);
...
////// Specular:
                ...
                float3 finalColor = 0;
                float3 diffuseLight = diffuse;
                finalColor += diffuseLight * lerp(node_2.rgb,(_node_147.rgb*tex2D(_node_121,TRANSFORM_TEX(node_157.rg, _node_121)).rgb),_bloodBlend);
                finalColor += specular;
/// Final Color:
